...
<aside class="app-sidebar">
    <ul class="app-menu">
        ...
        {{-- add new menu with all instrumemts and create new instument --}}
        <li class="treeview  @if(request()->path() == 'admin/instruments')  is-expanded
            @elseif(request()->path() == 'admin/instrument/{instrument}')  is-expanded
                    @endif">
        <a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-cog"></i><span class="app-menu__label">Manage Instrument</span><i class="treeview-indicator fa fa-angle-right"></i></a>
        <ul class="treeview-menu">
            <li><a class="treeview-item @if(request()->path() == 'admin/instruments') active @endif" href="{{route('instruments')}}"> Instruments</a></li>
            <li><a class="treeview-item @if(request()->path() == 'admin/instrument/{instrument}') active @endif" href="{{route('instruments.create')}}" rel="noopener"> Create Instrument</a></li>
        </ul>
    </li>
    {{-- end of new menu --}}
