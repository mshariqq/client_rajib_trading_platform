                        ...
                        <div class="login-form-wrapper">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="row">
                                    ...
                                    {{-- col-4 with form select dropwodn to select uer is seller or bueyer --}}
                                    <div class="col-lg-12">
                                        <div class="form-element margin-bottom-20">
                                            <select name="user_type" required class="input-field custom-select form-select">
                                                <option selected value="buyer">Select User Type *</option>
