    ...
    <div class="container">
        <div class="row ">
            ...
            <div class="col-lg-9">
                <div class="main-menu margin-top-20">
                    <ul>
                        ...
                        @if (auth()->user() != null && auth()->user()->type == 'seller')
                        <li><a href="{{route('trade.create')}}">New Trade</a></li>
                        @elseif(auth()->user() != null && auth()->user()->type == 'buyer')
                        <li><a href="{{route('trade')}}">Browse Trades</a></li>
                        @endif
            ...
            <div class="col-lg-2 d-flex align-items-center">
                <div class="sign-in">
                    <a href="{{route('login')}}">{{Auth::user()->type}}</a>
                </div>
            </div>
