...
// list & create new Trade
Route::get('/trade', 'TradeController@index')->name('trade');
// my trades
Route::get('/my-trades', 'TradeController@myTrades')->name('my-trades');
Route::get('/trade/create', 'TradeController@create')->name('trade.create');
Route::post('/trade/store', 'TradeController@store')->name('trade.store');
Route::get('/trade/{id}/edit', 'TradeController@edit')->name('trade.edit');
Route::post('/trade/{id}/update', 'TradeController@update')->name('trade.update');
Route::get('/trade/{id}/delete', 'TradeController@delete')->name('trade.delete');
Route::get('/trade/{id}/show', 'TradeController@show')->name('trade.show');
...
Route::group(['prefix' => 'admin', 'middleware' => 'auth:admin'], function () {
    ...
    // create routes for instruments CRUD
    // route to get all instruments
    Route::get('/instruments', 'InstrumentsController@index')->name('instruments');
    // route to create new instrument
    Route::get('/instrument/create', 'InstrumentsController@create')->name('instruments.create');
    // route to store new instrument
    Route::post('/instrument/create', 'InstrumentsController@store')->name('instruments.store');
    Route::get('instruments/{id}/delete', 'InstrumentsController@destroy')->name('instruments.destroy');
    Route::get('instruments/{id}/edit', 'InstrumentsController@edit')->name('instruments.edit');
    Route::post('instruments/{id}/update', 'InstrumentsController@update')->name('instruments.update');
    Route::get('instruments/{id}/show', 'InstrumentsController@show')->name('instruments.show');
    Route::get('instruments/{id}/delete', 'InstrumentsController@destroy')->name('instruments.delete');
